...
fig2_data <- read.table("data_fig1-1.txt", sep = "\t", header = TRUE)
fig3_data <- read.table("data_fig1-2.txt", sep = "\t", header = TRUE)
...
ggsave(fig2, filename="p_fig2.png", width=8, height=5, units="in")
...
ggsave(fig3, filename="p_fig3.png", width=8, height=5, units="in")
